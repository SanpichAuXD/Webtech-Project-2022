...
<body>
    ...
    <div>
        ...
        <!-- ชื่อ เมนู -->
        <div >
            <h3 id="name_value_set">Aroi Koom Set B</h3><br>
        ...
        <div class="btn-group " role="group" id="pom_select">
            <a onclick="hidNshopizza(2,2)" class="btn bg-warning text-light" id="pom_select_1" role="button">Choose Pizza</a>
            <a onclick="hidNshopizza(1,2)" class="btn" id="pom_select_2" role="button">Select Garlic Bread</a>
        </div>
    </div>
    <!-- หน้าต่างเลือกขอบ และ หน้า -->
    <div class="rounded " id="pizza1">
        <p class="text-center pt-5" style="font-size: 20px;">Choose Pizza</p>   
        ...
        <div class="btn-group" id="choose_dropdown">
            <div class="row ">
                <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center ">
                    <select id="selectpizza1" class="text-center form-select form-select-md mb-3" style="width: 200px;" aria-label=".form-select-md " onchange="reset(1); changePizza(1,1);">
                        <?php
                        $url = "pizza.json";
                ...
                <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center">
                    <select style="width: 200px;" id="selectcrust1" class="text-center form-select form-select-md mb-3" onchange="changePizza(1,1)" style="width: 250px;" aria-label=".form-select-md ">
