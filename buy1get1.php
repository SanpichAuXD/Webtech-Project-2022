...
<body onload="retrieve(); count(); is_empty();">
    ...
    <div class="rounded d-none" id="pizza2">
        <div class="left">
            ...
            <div class="btn-group" id="choose_dropdown">
                <div class="row">
                    <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center ">
                        <select id="selectpizza2" class="text-center form-select form-select-md mb-3 me-3 ms-3"
                            style="width: 100%;" aria-label=".form-select-md " onchange="reset(1); changePizza(2);">
                            <?php
                            $url = "pizza.json";
                            $response = file_get_contents($url);
                            $result = json_decode($response);
                    ...
                    <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center ">
                        <select style="width: 100%;" id="selectcrust2"
                            class="text-center form-select form-select-md mb-3 me-3 ms-3" onchange="changePizza(2)"
                            style="width: 100%;" aria-label=".form-select-md ">
    ...
    <div class="text-center mt-2">
        <a href="#pizza2" class="btn btn-success w-25  mt-5 mb-5"
            onclick="hidNshopizza(1,11); keepprice(0); reset(0); changePizza(2)" id="next1"> Next </a>
    </div>
    <div class="text-center mt-2 ">
        <a href="index.php" class="btn p-2 mt-5 w-25 mb-5 btn-success d-none" id="last"
