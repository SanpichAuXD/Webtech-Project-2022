    ...
    <body onload="setPrice(0)">
        ...
        <div>
            ...
            <div class="btn-group " role="group" id="pom_select">
                <a onclick="hidNshopizza(2,2)" class="btn bg-warning text-light" id="pom_select_1" role="button">Select Pizza</a>
                <a onclick="hidNshopizza(1,2)" class="btn" id="pom_select_2" role="button">Select Chicken Pop(M)</a>
            </div>
        </div>
        <!-- หน้าต่างเลือกขอบ และ หน้า -->
        <div class="rounded " id="pizza1">
        <p class="text-center pt-5" style="font-size: 20px;">Select 1st Pizza</p>
        <img src="./img/pan/Seafood_Cocktail_m.png" id="pizzapic1"
            ...
            <div class="row ">
                <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center ">
                    <select id="selectpizza1" class="text-center form-select form-select-md mb-3" style="width: 200px;"
                        aria-label=".form-select-md " onchange="reset(1); changePizza(1,1);">
                        <?php
                        $url = "pizza.json";
        ...
        <div class="text-center mt-2 ">
            <a href="#pizza1" class="btn p-2 mt-5 w-25 mb-5 btn-success d-none" id="last" onclick=""><i class="bi bi-cart">&nbsp&nbspAdd to Cart </i> </a>
        </div>
        <!-- footer -->
        <div id="footer">
        </div>
