...
<?php include 'background.php'; ?>
    ...
    <div class="text-center mt-2 ">
        <a href="value_set.php" class="btn p-2 mt-5 w-25 mb-5 btn-success d-none" id="last" onclick="count(); keepprice(0); addToCart(4);"><i class="bi bi-cart">&nbsp&nbspAdd to cart</i> </a>
    </div>
    <!-- footer -->
