...
<body>
    ...
    <div>
        ...
        <div>
            ...
            <h5 id="text_value_set">Enjoy with group with medium extreme crust pizza with classic topping, spaghetti
                129.-, chicken stick and waffle fries.</h5>
        </div>
        <!-- เลือกพิซซ่า | เลือกไก่ป๊อป -->
        <br><br>
        <div class="btn-group " role="group" id="pom_select">
            <a onclick="hidNshopizza46(1,4)" class=" btn bg-warning text-light" id="pom_select_1" role="button">Select
                Pizza</a>
            <a onclick="hidNshopizza46(2,4)" class="btn" id="pom_select_2" role="button">Select Pasta</a>
            <a onclick="hidNshopizza46(3,4)" class="btn" id="pom_select_3" role="button">Select Chicken Sticks</a>
            <a onclick="hidNshopizza46(4,4)" class="btn" id="pom_select_4" role="button">Select Select Waffle Fries</a>
        </div>
    </div>
    ...
    <div class="rounded  " id="pizza1">
        ...
        <img id="pizzapic1"
            src="https://cdn.discordapp.com/attachments/1012625488482680942/1034103058067636224/unknown.png" width="50%"
        ...
        <div class="btn-group" id="choose_dropdown">
            <div class="row ">
                <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center ">
                    <select id="selectpizza1" class="text-center form-select form-select-md mb-3" style="width: 200px;"
                        aria-label=".form-select-md " onchange=" reset(1); changePizza(1)">
                        <?php
                        $url = "pizza.json";
                ...
                <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center">
                    <select style="width: 200px;" id="selectcrust1" class="text-center form-select form-select-md mb-3"
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6   ">
                    <div class="  card m-3" id="card-topping" style="background-color: hsla(0, 0%, 100%,.7); ">
                        <div class="card-body">
                            <img src="https://cdn.discordapp.com/attachments/1012625488482680942/1034689297313452072/unknown.png"
                                style="width: 80%; 
                            height: 70px; 
                            object-fit: cover; 
                            display: block;
                ...
                <div class="col-12 col-md-6 ">
                    <div class="card m-3" id="card-topping" style="background-color: hsla(0, 0%, 100%,.7);">
                        <div class="card-body">
                            <img src="https://cdn.discordapp.com/attachments/1012625488482680942/1034689386215915570/unknown.png"
                                style="width: 80%; 
                            height: 70px; 
                            object-fit: cover; 
                            display: block;
        ...
        <div class="row mt-0 pb-3">
            ...
            <div class="col-12 col-md-6 ">
                <div class="card m-3" id="card-topping" style="background-color: hsla(0, 0%, 100%,.7);">
                    <div class="card-body">
                        <img src="https://cdn.discordapp.com/attachments/1012625488482680942/1034689386626945024/unknown.png"
                            style="width: 80%; 
                            height: 70px; 
                            object-fit: cover; 
                            display: block;
                ...
                <div class="col-12 col-md-6 ">
                    <div class="card m-3" id="card-topping" style="background-color: hsla(0, 0%, 100%,.7);">
                        <div class="card-body">
                            <img src="https://cdn.discordapp.com/attachments/1012625488482680942/1034689387075743764/unknown.png"
                                style="width: 80%; 
                            height: 70px; 
                            object-fit: cover; 
                            display: block;
        ...
        <div class="rounded pb-5 d-none" id="pizza2">
            ...
            <img id="spaimg"
                src="https://cdn.discordapp.com/attachments/1012625488482680942/1034726186162597958/unknown.png"
                width="50%" class="mx-auto d-block">
            <!-- disabled -->
            <div id="choose_dropdown">
                <div class="dropdown ">
                    <select id="selectspa" class="text-center form-select form-select-md mb-3"
                        style="width:80%; margin:auto;" aria-label=".form-select-md " onchange="changeSpa()">
                        <?php
                                $url = "pizza.json";
                                $response = file_get_contents($url);
                                $result = json_decode($response);
        ...
        <div class="rounded pb-5 d-none " id="pizza3">
            ...
            <img src="https://cdn.discordapp.com/attachments/1012625488482680942/1034726186548482048/unknown.png"
                width="50%" class="mx-auto d-block">
            <!-- disabled -->
        ...
        <div class="rounded pb-5 d-none" id="pizza4">
            ...
            <img src="https://cdn.discordapp.com/attachments/1012625488482680942/1034726186967900221/unknown.png"
                width="50%" class="mx-auto d-block">
            <!-- disabled -->
        ...
        <div class="text-center mt-2   ">
            <a href="#pizza2" class="btn btn-info w-25  mt-5 mb-5 " onclick="hidNshopizza(1,4); " id="next1">
                Next </a>
        </div>
        <div class="text-center mt-2   ">
            <a href="#pizza3" class="btn btn-info w-25  mt-5 mb-5 d-none" onclick="hidNshopizza(2,4); " id="next2"> Next
            </a>
        </div>
        <div class="text-center mt-2   ">
            <a href="#pizza4" class="btn btn-info w-25  mt-5 mb-5 d-none" onclick="hidNshopizza(3,4); " id="next3"> Next
            </a>
        </div>
        <div class="text-center mt-2 ">
            <a class="btn p-2 mt-5 w-25 mb-5 btn-success d-none" id="last" ><i class="bi bi-cart">&nbsp&nbspAdd
                    to Cart</i> </a>
        </div>
        <!-- footer -->
        <div id="footer">
