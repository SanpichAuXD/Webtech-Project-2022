...
<body>
    ...
    <div>
        ...
        <br><br>
        <div class=" row" role="group" id="pom_select">
            <a onclick="hidNshopizza46(1,6)" class="btn col-4" id="pom_select_1" role="button" style="border-top-right-radius: 0;
                border-bottom-right-radius: 0;
                border-bottom-left-radius: 0;">Select 1st Pizza</a>
            <a onclick="hidNshopizza46(2,6)" class="btn col-4" id="pom_select_2" role="button" style="border-top-right-radius: 0;
                border-top-left-radius: 0;
                border-bottom-right-radius: 0;
                border-bottom-left-radius: 0;">Select 2nd Pizza</a>
            <a onclick="hidNshopizza46(3,6)" class="btn col-4" id="pom_select_3" role="button" style="border-top-left-radius: 0;
                border-bottom-right-radius: 0;
                border-bottom-left-radius: 0;">Select Pasta</a>
            <a onclick="hidNshopizza46(4,6)" class="btn col-4" id="pom_select_4" role="button" style="border-top-right-radius: 0;
                border-top-left-radius: 0;
                border-bottom-right-radius: 0;">Select Chicken Wings</a>
            <a onclick="hidNshopizza46(5,6)" class="btn col-4" id="pom_select_5" role="button" style="border-top-right-radius: 0;
                border-top-left-radius: 0;
                border-bottom-right-radius: 0;
                border-bottom-left-radius: 0;">Select Fish Finger</a>
            <a onclick="hidNshopizza46(6,6)" class="btn col-4" id="pom_select_6" role="button" style="border-top-right-radius: 0;
                border-top-left-radius: 0;
                border-bottom-left-radius: 0;">Select Waffle Fries</a>
        </div>
    </div>
    <!-- ถาด1 -->
        ...
        <div class="btn-group" id="choose_dropdown">
            <div class="row ">
                <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center ">
                    <select id="selectpizza1" class="text-center form-select form-select-md mb-3 me-3 ms-3" style="width: 100%;" aria-label=".form-select-md " onchange="changePizza(1)">
                        <?php
                        $url = "pizza.json";
    ...
    <div class="rounded d-none" id="pizza2">
        ...
        <div class="btn-group" id="choose_dropdown">
            <div class="row ">
                <div class="col-12 col-sm-6 d-flex justify-content-center align-item-center ">
                    <select id="selectpizza1" class="text-center form-select form-select-md mb-3 me-3 ms-3" style="width: 100%;" aria-label=".form-select-md " onchange="reset(1); changePizza(1);">
                        <?php
                        $url = "pizza.json";
                        $response = file_get_contents($url);
                        $result = json_decode($response);
    ...
    <div class="text-center mt-2   ">
        <a href="#pizza2" class="btn btn-info w-25  mt-5 mb-5 " onclick="hidNshopizza(1,6)" id="next1"> Next </a>
    </div>
    <div class="text-center mt-2   ">
        <a href="#pizza3" class="btn btn-info w-25  mt-5 mb-5 d-none" onclick="hidNshopizza(2,6)" id="next2"> Next </a>
    </div>
    <div class="text-center mt-2   ">
